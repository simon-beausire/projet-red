...
func (u User) displayInfoNain() {
	...
	fmt.Println("                              |")
	fmt.Println("                              |                      Nom : Throrin Forgeflamme")
	fmt.Println("                              |                      Âge : 178 ans")
	fmt.Println("                              |                      Origine : Montagnes de Fer, royaume souterrain de Khar-Dûm")
	fmt.Println("                              |")
	fmt.Println("                              |                      Histoire de Throrin Forgeflamme")
	fmt.Println("                              |                      Throrin est né dans le clan Forgeflamme, réputé pour ses artisans et forgerons d’exception. Dès son plus jeune âge, ")
	...
	fmt.Println("                              |")
	fmt.Println("                              |                      Throrin, animé par un sens profond de l’honneur et du devoir, a juré de retrouver la Lame du Crépuscule. ")
	...
	fmt.Println("                              |")
	fmt.Println("                              |                      Mais plus que tout, Throrin Forgeflamme devra affronter une menace grandissante : ")
...
func (u User) displayInfoAssassin() {
	...
	fmt.Println("                              |", "                                       Points de vie    : ", string(u.PdvActuel+48), "/", string(u.PdvMax))
	fmt.Println("                              |")
	fmt.Println("                              |                      Nom : Kaelen Ombrenoir")
	fmt.Println("                              |                      Âge : 29 ans")
	fmt.Println("                              |                      Origine : La cité-État d’Eryndal, ruelles obscures et marchés noirs")
	fmt.Println("                              |")
	fmt.Println("                              |                      Histoire de Kaelen Ombrenoir")
	fmt.Println("                              |                      Kaelen est né dans les bas-fonds d’Eryndal, une cité rongée par la corruption et les complots. Orphelin très jeune, ")
	...
	fmt.Println("                              |                      ")
	fmt.Println("                              |                      Kaelen travaille dans l’ombre pour des causes variées — assassinats politiques, élimination de traîtres, ")
...
func (u User) displayInfoElfe() {
	...
	fmt.Println("                              |", "                                       Points de vie    : ", string(u.PdvActuel+48), "/", string(u.PdvMax))
	fmt.Println("                              |")
	fmt.Println("                              |                      Nom : Elyra Ventargent")
	fmt.Println("                              |                      Âge : 243 ans (jeune adulte pour une elfe)")
	fmt.Println("                              |                      Origine : Forêt d’Élyndra, royaume sylvestre des Hauts-Arbres")
	fmt.Println("                              |")
	fmt.Println("                              |                      Histoire d’Elyra Ventargent")
	fmt.Println("                              |                      Elyra est née sous la canopée millénaire d’Élyndra, un sanctuaire naturel préservé des hommes et des conflits, ")
	...
	fmt.Println("                              |")
	fmt.Println("                              |                      Dotée d’une sensibilité unique, Elyra communique avec les animaux et peut manipuler doucement les vents ")
	...
	fmt.Println("                              |                      la magie de la forêt pour leurs propres desseins. Elyra a été choisie par les Anciens pour partir en quête des Cristaux de Lune, ")
	...
	fmt.Println("                              |                      Entre tradition et changement, Elyra devra définir ce que signifie vraiment être une gardienne.")
	fmt.Println("                              |                      ")
	fmt.Println("                              |                      ")
	fmt.Println("                              |")
}
